...
<aside id="colorlib-aside" role="complementary" class="border js-fullheight">
    <div class="text-center">
      ...
      <h1 id="colorlib-logo"><a href="index.php">Adarsh Kumar</a></h1>
    ...
    <nav id="colorlib-main-menu" role="navigation" class="navbar">
      <div id="navbar" class="collapse">
        <ul>
          ...
          <li><a href="./travel_diaries.php">Travel Diaries</a></li>
          <li><a href="./general_articles.php">General Articles</a></li>
          <li><a href="./economic_analysis.php">Economic Analysis</a></li>
          <li><a href="./history_ideology.php" >Ideologies  And<br/>Contempory History</a></li>
